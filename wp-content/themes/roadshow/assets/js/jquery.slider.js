 ...
 */(function (e) {
    ...
    e.fn.bjqs = function (t) {
        var n = {width: 700, height: 300, animtype: "fade", animduration: 450, animspeed: 4e3, automatic: !0, showcontrols: !0, centercontrols: !0, nexttext: '<i class="fa fa-angle-right"></i>', prevtext: '<i class="fa fa-angle-left"></i>', showmarkers: !0, centermarkers: !0, keyboardnav: !0, hoverpause: !0, usecaptions: !0, randomstart: !1, responsive: !1}, r = e.extend({}, n, t), i = this, s = i.find("ul.bjqs"), o = s.children("li"), u = null, a = null, f = null, l = null, c = null, h = null, p = null, d = null, v = {slidecount: o.length, animating: !1, paused: !1, currentslide: 1, nextslide: 0, currentindex: 0, nextindex: 0, interval: null}, m = {width: null, height: null, ratio: null}, g = {fwd: "forward", prev: "previous"}, y = function () {
            o.addClass("store-slide");
            r.responsive ? b() : E();
            if (v.slidecount > 1) {
                r.randomstart && L();
                r.showcontrols && x();
            ...
            h = e('<div class="store-slide-wrapper"></div>');
            ...
            u = e('<ul class="store-slide-controls"></ul>');
            a = e('<li class="store-slide-next"><a href="#" data-direction="' + g.fwd + '">' + r.nexttext + "</a></li>");
            f = e('<li class="store-slide-prev"><a href="#" data-direction="' + g.prev + '">' + r.prevtext + "</a></li>");
            ...
            l = e('<ol class="store-slide-markers"></ol>');
            ...
            e.each(o, function (t, n) {
                ...
                if (r) {
                    r = e('<p class="store-slide-caption">' + r + "</p>");
                    r.appendTo(e(n))
                }
            })
        }, L = function () {
